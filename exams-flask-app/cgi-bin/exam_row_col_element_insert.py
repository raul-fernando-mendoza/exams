        ...
        for row in reasonsPerRow[exercise]:
            ...
            for col in reasonsPerRow[exercise][row]:
                ...
                for observacion in reasonsPerRow[exercise][row][col]:
                    ...
                    if(r != 0):
                        observacion = exam_models.ExamRowColElement(type_id="1", exercise_id=exercise, row_id=row, col_id=col, element_id=observacion["id"], label=observacion["label"], ind=i+1)
                        i = i+1
